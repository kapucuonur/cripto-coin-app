...
export default class SearchBar {
  ...
  render() {
    ...
    this.backButton.className = 'btn btn-primary me-2 d-none';
    this.backButton.innerHTML = '<i class="fas fa-arrow-left"></i> Back to Search';
    this.backButton.addEventListener('click', this.onBackToSearch);
