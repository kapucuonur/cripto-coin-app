...
import Alert from './components/Alert.js'; // Make sure to import Alert
...
class App {
  ...
  render() {
    ...
    container.appendChild(this.searchBar.render()); // Fixed: using this.searchBar
  ...
  handleSearch(searchValue) {
    ...
    // Show back button after successful search
    if (this.searchBar) {
